...
const artists = ["Milo Stellan", "Elara Lune", "Celestia Vrai"];
const artistDecriptions = [
    "Channeling the raw energy of rock with a touch of bluesy grit, Milo Stellan delivers powerful anthems that resonate with the rebellious spirit of yesteryears. His raspy vocals and electric guitar riffs are reminiscent of smoky bars and freedom roads.", 
    ...
    "With a voice as crisp as mountain air, Celestia Vrai melds folk traditions with modern indie sensibilities. Her songs tell tales of natures wonders, loves intricacies, and the timeless dance of seasons, all wrapped in acoustic warmth."
]; // GENERATED BY CHATGPT


// footer functionality
function scrollToBottom() {
    window.scrollTo({ top: document.body.scrollHeight, behavior: "smooth" }); //scroll to lowest possible hight
...
// Event listener to toggle the display of the chevrons (whether the up chevron or down chevron are displayed)
...
if (window.scrollY /* current scroll pos  */ + 
    window.innerHeight /* height of page */  >= 
    document.body.scrollHeight /**total height of doc */ - 
    50 /** buffer of px */) {  
